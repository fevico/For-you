...
async fetchProducts(
  ...
  // @Get(':countryCode')
  // @HttpCode(200)
  // @ApiOperation({ summary: 'Get gift card produccts for a specific country' })
  // @ApiParam({
  //   name: 'countryCode',
  ...
  @Get(':countryCode')
@HttpCode(200)
@ApiOperation({ summary: 'Get gift card products for a specific country' })
@ApiParam({
  name: 'countryCode',
  description: 'ISO-3166-1 alpha-2 code (e.g. US, GB, NG)',
  example: 'US',
...
async fetchByCountryCode(
  ...
  return this.giftcardService.getByCountryCode(
